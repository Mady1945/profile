...
const ProjectSection2 = ({pic, project_no , title, description}) => {
  return (
    <main className='lg:flex  lg:flex-row flex flex-col lg:w-[80%] lg:h-[70vh] py-32  m-auto  lg:space-x-32 space-y-20'>
